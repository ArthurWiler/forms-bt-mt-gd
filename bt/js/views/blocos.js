      ...
      blocos.map((b, bi) =>
        /* @__PURE__ */ React.createElement(
          ...
          /* @__PURE__ */ React.createElement(
            ...
            /* @__PURE__ */ React.createElement(
              Field,
              { label: `Demanda do ${atend.atendA} (kVA)` },
              /* @__PURE__ */ React.createElement(Inp, {
                type: "text",
                readOnly: true,
                disabled: true,
            ...
            /* @__PURE__ */ React.createElement(
              Field,
              { label: `Qtd. de UCs por ${atend.atendA}`, req: true },
              /* @__PURE__ */ React.createElement(Inp, {
                type: "number",
                value: b.qtdUCs,
            ...
            /* @__PURE__ */ React.createElement(
              Field,
              { label: "Disjuntor do Condomínio / Sist. Combate Incêndio" },
              /* @__PURE__ */ React.createElement(
                Sel,
                {
            ...
            /* @__PURE__ */ React.createElement(
              Field,
              { label: "Demanda Condomínio / Combate Incêndio (kVA)" },
              /* @__PURE__ */ React.createElement(Inp, {
                type: "number",
            ...
            calcBlocoMultiTorres(b).temNaoResidencial &&
              /* @__PURE__ */ React.createElement(
                Field,
                {
                  ...
                  req: true,
                  hint: "Demanda calculada pelo responsável técnico para as UCs não residenciais desta torre — não é a soma das UCs.",
                },
                /* @__PURE__ */ React.createElement(Inp, {
                  type: "number",
          ...
          calcBlocoMultiTorres(b).nd52 &&
            /* @__PURE__ */ React.createElement(
              ...
              /* @__PURE__ */ React.createElement(
                "b",
                null,
                "Demanda residencial (ND-5.2) desta torre:",
              ),
              " ",
              calcBlocoMultiTorres(b).qtdApart,
              " apartamento(s) · área média ",
              fmt2(calcBlocoMultiTorres(b).areaMedia),
              " m² → ",
              fmt2(calcBlocoMultiTorres(b).nd52.demandaKVA),
              " kVA.",
            ),
          (b.ucs || []).length > 0 &&
            /* @__PURE__ */ React.createElement(
              "div",
              { className: "uc-torre-wrap" },
              /* @__PURE__ */ React.createElement(
                "div",
                {
                  style: {
                ...
                b.ucs.length > 1 &&
                  /* @__PURE__ */ React.createElement(
                    Btn,
                    { variant: "ghost", onClick: () => replicarUC1Torre(bi) },
              ...
              b.ucs.map((u, ui) =>
                /* @__PURE__ */ React.createElement(
                  "div",
                  { key: ui, className: "uc-mini" },
                  /* @__PURE__ */ React.createElement(
                    "div",
                    { className: "uc-mini-head" },
                    "UC ",
                    ui + 1,
                    ui === 0 &&
                      b.ucs.length > 1 &&
                    ...
                    u.atividade === "Residencial" &&
                      /* @__PURE__ */ React.createElement(
                        Field,
                        {
                          label: "Área (m²)",
                          req: true,
                          hint: "Área privativa do apartamento — usada no cálculo ND-5.2 por torre.",
                        },
                        /* @__PURE__ */ React.createElement(Inp, {
                          type: "number",
                          value: u.area,
                          onChange: (e) =>
                            setUcTorre(bi, ui, { area: e.target.value }),
                          placeholder: "Ex: 65",
                        }),
                      ),
          ...
          (b.ucs || []).length > 0 &&
            /* @__PURE__ */ React.createElement(
              "div",
              { className: "prev-table-wrap", style: { marginTop: 14 } },
              /* @__PURE__ */ React.createElement(
                "div",
                ...
                b.ucs.length > 1 &&
                  /* @__PURE__ */ React.createElement(
                    Btn,
                    { variant: "ghost", onClick: () => replicarPrevTorre(bi) },
