function TabUcsColetivo({ ctx }) {
  ...
  return /* @__PURE__ */ React.createElement("div", null, hibrido && !validacaoHibrido.ok && /* @__PURE__ */ React.createElement("div", { className: "alert alert-warn", style: { marginBottom: 14 } }, /* @__PURE__ */ React.createElement("strong", null, "Atendimento híbrido — pendências:"), /* @__PURE__ */ React.createElement("ul", { style: { margin: "6px 0 0", paddingLeft: 18 } }, validacaoHibrido.erros.map((e, i) => /* @__PURE__ */ React.createElement("li", { key: i }, e)))), hibrido && validacaoHibrido.ok && /* @__PURE__ */ React.createElement("div", { className: "alert alert-ok", style: { marginBottom: 14 } }, "Classificação ND 5.1 / ND 5.2 das UCs está consistente."), /* @__PURE__ */ React.createElement(
    Card,
    {
    ...
    ucBlocos.map((u, ui) => /* @__PURE__ */ React.createElement("div", { key: ui, className: "uc-block" }, /* @__PURE__ */ React.createElement("div", { className: "uc-block-head" }, /* @__PURE__ */ React.createElement("span", { className: "uc-block-title" }, u.identificacao || `UC ${ui + 1}`), /* @__PURE__ */ React.createElement(Badge, null, ui + 1, " de ", ucBlocos.length)), /* @__PURE__ */ React.createElement("div", { className: "grid grid-3" }, hibrido && /* @__PURE__ */ React.createElement(Field, { label: "Norma de atendimento" }, /* @__PURE__ */ React.createElement(
    ...
    )), /* @__PURE__ */ React.createElement(Field, { label: "Identificação" }, /* @__PURE__ */ React.createElement(
      Inp,
      {
        value: u.identificacao,
        onChange: (e) => setBloco(ui, { identificacao: e.target.value })
      }
    )), hibrido && u.nd === "5.1" ? /* @__PURE__ */ React.createElement(Field, { label: "Nº Predial", req: true, hint: "Distinto entre as UCs" }, /* @__PURE__ */ React.createElement(
      Inp,
      {
        value: u.nPredial,
        onChange: (e) => setBloco(ui, { nPredial: e.target.value })
      }
    )) : /* @__PURE__ */ React.createElement(Field, { label: "Nº Predial" }, /* @__PURE__ */ React.createElement("div", { className: "readonly-val" }, obra.num || "Nº Predial")), /* @__PURE__ */ React.createElement(Field, { label: "Complemento", req: ucBlocos.length > 1 }, /* @__PURE__ */ React.createElement(
      Inp,
      {
        value: u.complemento,
    ...
    )), /* @__PURE__ */ React.createElement(Field, { label: "Disjuntor", span: 3 }, /* @__PURE__ */ React.createElement("div", { className: "disj-pair" }, u.solicitacao !== "Conexão Nova" && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(
      Sel,
      {
        value: u.disjDe,
      ...
      /* @__PURE__ */ React.createElement("option", { value: "" }, u.solicitacao === "Conexão Nova" ? "Disjuntor solicitado…" : "Para: (solicitado)…"),
