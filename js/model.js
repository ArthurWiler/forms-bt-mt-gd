...
const MODALIDADES_SECOES = [
  {
    ...
    cards: [
      ...
      },
      {
        ...
        nome: "Comércio",
        sub: "Baixa Tensão (BT)",
        img: "shared/imgs/img_comercio.png",
        status: "ok",
        prefill: {
          atividade: "Comercial",
          atend: {
      ...
      },
      {
        ...
        nome: "Indústria",
        sub: "Baixa Tensão (BT)",
        img: "shared/imgs/img_industria_bt.png",
        status: "ok",
        prefill: {
    ...
    cards: [
      {
        ...
        nome: "Loteamento",
        sub: "Baixa Tensão (BT)",
        img: "shared/imgs/img_loteamento.png",
        status: "link",
        href: "loteamento/",
      },
      {
        ...
        sub: "Baixa Tensão (BT)",
        img: "shared/imgs/img_condominio.png",
        status: "ok",
        prefill: {
          atividade: "Residencial",
          atend: {
      ...
      },
      {
        ...
        sub: "Baixa Tensão (BT)",
        img: "shared/imgs/img_coletivo.png",
        status: "ok",
        prefill: {
          atividade: "Residencial",
          atend: {
    ...
    cards: [
      {
        ...
        nome: "Indústria",
        sub: "Média Tensão (MT)",
        img: "shared/imgs/img_industria_mt.png",
        status: "link",
      ...
      },
      {
        ...
        sub: "Média Tensão (MT)",
        img: "shared/imgs/img_outros_mt.png",
        status: "link",
        href: "mt/",
      },
      {
        ...
        nome: "Irrigante",
        sub: "Média Tensão (MT)",
        img: "shared/imgs/img_irrigante.png",
        status: "link",
    ...
    cards: [
      {
        ...
        nome: "Microgeração",
        sub: "Baixa Tensão (BT)",
        img: "shared/imgs/mod-gd-micro.png",
        status: "link",
        href: "microgeracao/",
      },
      {
        ...
        nome: "Minigeração",
        sub: "Média Tensão (MT)",
        img: "shared/imgs/mod-gd-mini.png",
        status: "link",
        href: "minigeracao/",
      },
    ],
