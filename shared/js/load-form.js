...
function CalcDemanda({
  ...
  const upd = (patch) => onChange({ ...d, qtds, tipoA, catA, mots, extras, ...patch });
      ...
      : /* @__PURE__ */ React.createElement(
          ...
          /* @__PURE__ */ React.createElement(
            ...
            /* @__PURE__ */ React.createElement(
              ...
              /* @__PURE__ */ React.createElement("th", null, "Dem. unit. (kVA)"),
              /* @__PURE__ */ React.createElement("th", null, "Dem. total (kVA)"),
          ...
          /* @__PURE__ */ React.createElement(
            ...
            linhas.map((m, mi) => {
              ...
              return /* @__PURE__ */ React.createElement(
                ...
                /* @__PURE__ */ React.createElement(
                  ...
                  /* @__PURE__ */ React.createElement(
                    ...
                    (m.fase === "mono" ? MOTOR_MONO : MOTOR_TRI).map((r) =>
                      /* @__PURE__ */ React.createElement("option", { key: r.cv, value: r.cv }, r.l)
                    )
                  )
                ),
                /* @__PURE__ */ React.createElement(
                ...
                /* @__PURE__ */ React.createElement("td", { className: "num" }, fmt2(linha.kvaUnit || 0)),
                /* @__PURE__ */ React.createElement("td", { className: "num" }, fmt2(linha.kva || 0)),
                /* @__PURE__ */ React.createElement(
                  "td",
                  null,
                  /* @__PURE__ */ React.createElement(
                    ...
                    {
                      type: "button",
                      onClick: () => upd({ [chave]: linhas.filter((_, x) => x !== mi) }),
                      className: "motor-del",
                    },
                    "✕"
                  )
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Field, { label: "Tipo de carga", req: true }, /* @__PURE__ */ React.createElement("div", { className: "toggle-group", style: { alignItems: "center" } }, /* @__PURE__ */ React.createElement(Sel, { value: tipoA, disabled: tipoCargaBloqueado, onChange: (e) => upd({ tipoA: e.target.value }) }, /* @__PURE__ */ React.createElement("option", { value: "" }, "Selecionar"), /* @__PURE__ */ React.createElement("option", { value: "res" }, "Residencial"), /* @__PURE__ */ React.createElement("option", { value: "nr" }, "Não-Residencial")), tipoA === "nr" && /* @__PURE__ */ React.createElement(
    ...
    TABELA_11.map((c, i) => /* @__PURE__ */ React.createElement("option", { key: i, value: i }, c.d))
  ))), !tipoA ? /* @__PURE__ */ React.createElement("div", { className: "field-hint", style: { marginTop: 10 } }, "Selecione o tipo de carga para detalhar os equipamentos.") : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "carga-min-head", style: { marginTop: 12 } }, /* @__PURE__ */ React.createElement("span", { className: "subbox-title" }, "Equipamentos selecionados"), /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
  ...
  )), minimizado ? /* @__PURE__ */ React.createElement("div", { className: "carga-resumo" }, CAT.map((c, i) => ({ ...c, i, q: qtds[i] || 0 })).filter(
    (c) => c.q > 0
  ).length === 0 ? /* @__PURE__ */ React.createElement("div", { className: "field-hint" }, "Nenhum equipamento selecionado.") : CAT.map((c, i) => ({ ...c, i, q: qtds[i] || 0 })).filter((c) => c.q > 0).map((c) => /* @__PURE__ */ React.createElement("span", { key: c.i, className: "carga-resumo-chip" }, c.q, "x ", c.n))) : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { marginTop: 12 } }, /* @__PURE__ */ React.createElement(Field, { label: "Buscar equipamento" }, /* @__PURE__ */ React.createElement(
    Inp,
    {
      value: busca,
  ...
  ))), /* @__PURE__ */ React.createElement("div", { className: "carga-box", style: { marginTop: 8 } }, GO.map((sg) => {
    const items = catFiltrado.filter((c) => c.g === sg);
    if (!items.length) return null;
    return /* @__PURE__ */ React.createElement("div", { key: sg }, /* @__PURE__ */ React.createElement("div", { className: "carga-group-title" }, GL[sg]), items.map((c) => /* @__PURE__ */ React.createElement("div", { key: c.i, className: "carga-row" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "nome" }, c.n, " ", /* @__PURE__ */ React.createElement("span", { className: "pot" }, "(", fmtW(c.w), " W)"))), /* @__PURE__ */ React.createElement("div", { className: "qtd-ctrl" }, /* @__PURE__ */ React.createElement(
      "button",
      {
  ...
  }))), /* @__PURE__ */ React.createElement("div", { className: "subbox motores-box" }, /* @__PURE__ */ React.createElement("div", { className: "motores-head" }, /* @__PURE__ */ React.createElement("span", { className: "subbox-title" }, "Motores / Cargas Especiais"), /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
    ...
    "+ Motor"
  )), tabelaMotores(mots, rD.det, mots, "mots", "Nenhum motor adicionado.")),
  mostrarCargasAdicionais && /* @__PURE__ */ React.createElement("div", { className: "subbox motores-box", style: { marginTop: 12 } }, /* @__PURE__ */ React.createElement("div", { className: "motores-head" }, /* @__PURE__ */ React.createElement("span", { className: "subbox-title" }, "Cargas Adicionais"), /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
      className: "btn btn-primary",
      style: { padding: "5px 12px", fontSize: 12 },
      onClick: () => upd({ extras: [...extras, { fase: "mono", cv: "1", q: 1 }] })
    },
    "+ Carga Adicional"
  )), /* @__PURE__ */ React.createElement("div", { className: "field-hint", style: { marginBottom: 8 } }, "Para cargas que não constam na lista predefinida. Cada item usa a mesma estrutura dos motores e é somado à demanda."), tabelaMotores(extras, rD.detExtras, extras, "extras", "Nenhuma carga adicional informada.")),
  rD.d > 0 && /* @__PURE__ */ React.createElement("div", { className: "motores-total" }, "Demanda dos motores e cargas adicionais: ", fmt2(rD.d), " kVA")));
}
